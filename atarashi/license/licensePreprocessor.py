...
@plac.annotations(
  licenseList = plac.Annotation("Specify the license list file which contains licenses", "positional", str, metavar="PROCESSEDLICENSELIST"),
...
def main(licenseList, processedFile, verbose=0):
