...
@plac.annotations(
  licenseList = plac.Annotation("Specify the license list file of fossology which contains licenses", "positional", str, metavar="LICENSELIST"),
...
def main(licenseList, requiredlicenseList, verbose=0):
